...
const screenshots = [
  { src: "/subscan-screenshot-welcome.png", title: "Get Started Onboarding", desc: "Introduction to subscription cost analysis and offline scanning parameters." },
  { src: "/subscan-screenshot-empty.png", title: "Scan Inbox / SMS Audit", desc: "Allows auditing inbox transactions to locate recurrent billing patterns." },
  { src: "/subscan-screenshot-dashboard.png", title: "Expenditure Dashboard", desc: "Displays active subscription items and upcoming payment schedules." },
  { src: "/subscan-screenshot-assistant.png", title: "Smart Assistant Insights", desc: "Details premium optimizations, including overlapping services notifications." }
];

export default function SubScanProduct() {
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 space-y-16">
        ...
        <div className="space-y-6 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 pt-2">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight">SubScan</h1>
            <span className="w-fit inline-flex items-center px-2.5 py-0.5 rounded-full border border-blue-500/20 bg-blue-500/5 text-blue-400 text-[10px] font-bold uppercase tracking-wider">
              Beta Testing
            </span>
          </div>
          <p className="text-base sm:text-lg text-zinc-400 leading-relaxed max-w-3xl">
            A clean subscription auditing utility. Designed to track recurring expenditures and analyze overlaps locally. Incorporates visual calendar graphs, billing triggers, and category spend insights.
          </p>
        </div>
        ...
        <div className="w-full border border-[#1f1f27] bg-[#0c0c10] rounded-2xl p-6 sm:p-12 flex justify-center items-center overflow-hidden relative shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
          ...
          <div className="relative w-[260px] h-[520px] rounded-3xl overflow-hidden border border-zinc-800 bg-[#0d0d12] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] z-10 transition-transform duration-550 hover:scale-[1.01]">
            ...
            <Image 
              src="/subscan-screenshot-dashboard.png" 
              alt="SubScan Hero Dashboard" 
              fill 
              sizes="260px"
              priority
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pt-4">
          <div className="lg:col-span-5 space-y-6">
            <h2 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
              <Info className="w-3.5 h-3.5 text-blue-400" /> Product Overview
            </h2>
            <div className="text-sm text-zinc-400 space-y-4 leading-relaxed">
              <p>
                SubScan helps users manage recurring service contracts. By entering active plans and billing dates, users can visualize monthly costs and optimize personal budgets.
              </p>
              <p>
                The app&apos;s scanning algorithms analyze transaction histories locally on your device to flag hidden subscriptions, providing clear financial insights without sending data to external servers.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-5 rounded-xl border border-[#1f1f27] bg-[#101014] space-y-2.5">
                ...
                <h3 className="text-sm font-bold text-white">Expenditure Tracking</h3>
                <p className="text-xs text-zinc-500 leading-relaxed">Breaks down subscription spending by category to identify areas for budget optimization.</p>
              </div>

              <div className="p-5 rounded-xl border border-[#1f1f27] bg-[#101014] space-y-2.5">
                <Calendar className="w-5 h-5 text-blue-400" />
                <h3 className="text-sm font-bold text-white">Renewal Alerts</h3>
                <p className="text-xs text-zinc-500 leading-relaxed">Triggers local push alerts prior to renewals, helping avoid unwanted charges.</p>
              </div>

              <div className="p-5 rounded-xl border border-[#1f1f27] bg-[#101014] space-y-2.5">
                <ShieldAlert className="w-5 h-5 text-blue-400" />
                <h3 className="text-sm font-bold text-white">Privacy Architecture</h3>
                <p className="text-xs text-zinc-500 leading-relaxed">Your financial transactions and logs remain entirely isolated inside local system storage vaults.</p>
              </div>

              <div className="p-5 rounded-xl border border-[#1f1f27] bg-[#101014] space-y-2.5">
                <Cpu className="w-5 h-5 text-blue-400" />
                <h3 className="text-sm font-bold text-white">Overlaps Detection</h3>
                <p className="text-xs text-zinc-500 leading-relaxed">Identifies concurrent services (e.g. video platforms) and prompts potential consolidation actions.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {screenshots.map((s, idx) => (
              ...
              >
                ...
                <div className="text-center">
                  <h4 className="text-[11px] font-bold text-white group-hover:text-blue-400 transition-colors">{s.title}</h4>
                </div>
              </button>
            ))}
          </div>
        ...
        <div className="space-y-6 pt-4 border-t border-[#1f1f27]/40">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-zinc-400 text-xs">
            ...
            <div className="space-y-1">
              <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-500">Analytics Engine</span>
              <p className="font-semibold text-white">Subscription Analytics</p>
            </div>
            <div className="space-y-1">
              <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-500">Local Vaults</span>
              <p className="font-semibold text-white">Room Caching Layer</p>
            </div>
            <div className="space-y-1">
              <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-500">Sync Schema</span>
        ...
        <div className="w-full bg-gradient-to-r from-[#101014] to-[#15151e] border border-[#1f1f27] rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto space-y-6 relative z-10">
            <h3 className="text-xl sm:text-2xl font-bold text-white">Closed Beta Program</h3>
            <p className="text-xs sm:text-sm text-zinc-400">
              SubScan is currently under closed testing. We are refining categorization analytics and local SMS parsing security protocols.
            </p>
